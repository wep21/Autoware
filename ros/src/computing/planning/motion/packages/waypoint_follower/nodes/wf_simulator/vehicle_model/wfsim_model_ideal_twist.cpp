...
double WFSimModelIdealTwist::getX() { return state_(IDX::X); };
double WFSimModelIdealTwist::getY() { return state_(IDX::Y); };
double WFSimModelIdealTwist::getYaw() { return state_(IDX::YAW); };
double WFSimModelIdealTwist::getVx() { return input_(IDX_U::VX_DES); };
